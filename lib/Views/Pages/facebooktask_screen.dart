...
class FacebookTask extends StatefulWidget {
  const FacebookTask({Key? key}) : super(key: key);

  @override
  State<FacebookTask> createState() => _FacebookTaskState();
}


class _FacebookTaskState extends State<FacebookTask> {
  @override
  void initState() {
    super.initState();
    Provider.of<SocialMediaProvider>(context,listen: false).getFacebookPost(context);
  }
  @override
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children:  [
                          ...
                          Text("Facebook Tasks",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 25),),
                          InkWell
                            (
                              onTap: (){
                            ...
                            builder: (context, socialMediaProvider, child) {
                              if(socialMediaProvider.facebookTaskLoading){
                                ...
                                return ListView.separated(
                                  ...
                                  shrinkWrap: true,
                                  itemCount: socialMediaProvider.facebookTasksList.length,
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children:[
                                                  Text(
                                                    socialMediaProvider.facebookTasksList[index].action,
                                                    maxLines: 2,
