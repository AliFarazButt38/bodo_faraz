                ...
                child: Card(
                  ...
                  child: ListTile(
                    title: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 5,),
                          Text("Complete Tasks to earn points",style: TextStyle(color: Colors.grey,fontSize: 15)),
                        ],
                      ),
                    ),
                    // subtitle: Padding(
                    ...
                    leading: Padding(
                      ...
                      child: Column(
                        children: const [
                          ImageIcon(AssetImage('assets/icons/social.png',),size: 30,color: Colors.black,),
                        ],
